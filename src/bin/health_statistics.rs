...
impl User {
    ...
    pub fn visit_doctor(&mut self, measurements: Measurements) -> HealthReport {
        ...
        if self.last_blood_pressure.is_none() {
            ...
            let blood_pressure_change = (measurements.blood_pressure.0 as i32 - last_blood_pressure.0 as i32,measurements.blood_pressure.1 as i32 - last_blood_pressure.1 as i32);
            self.last_blood_pressure = Some(measurements.blood_pressure);
            HealthReport {
                patient_name: self.name(),
                visit_count: self.doctor_visits(),
                height_change,
                blood_pressure_change: Some(blood_pressure_change),
            }
        }
    }
}
